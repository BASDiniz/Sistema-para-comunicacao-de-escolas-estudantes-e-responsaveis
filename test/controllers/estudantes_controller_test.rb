...
class EstudantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudante" do
    assert_difference('Estudante.count') do
      post estudantes_url, params: { estudante: { cpf: @estudante.cpf, nome: @estudante.nome, turma_id: @estudante.turma_id } }
    end
  ...
  test "should update estudante" do
    patch estudante_url(@estudante), params: { estudante: { cpf: @estudante.cpf, nome: @estudante.nome, turma_id: @estudante.turma_id } }
