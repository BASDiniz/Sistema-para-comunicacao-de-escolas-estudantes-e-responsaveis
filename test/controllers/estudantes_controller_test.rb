...
class EstudantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estudante" do
    assert_difference('Estudante.count') do
      post estudantes_url, params: { estudante: { cpf: @estudante.cpf, nome: @estudante.nome, serie: @estudante.serie, turma: @estudante.turma } }
    end
  ...
  test "should update estudante" do
    patch estudante_url(@estudante), params: { estudante: { cpf: @estudante.cpf, nome: @estudante.nome, serie: @estudante.serie, turma: @estudante.turma } }
